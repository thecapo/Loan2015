package org.bhi.stage3.testmodels;

import org.bhi.stage3.models.HomeLoan;
import org.bhi.stage3.models.InvestmentLoan;
...
public class TestLoanApp {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Investment Loan Amount : " + nfmt.format(john.getLoanamount()));
        System.out.println("Investment Loan Reinvest Option : " + john.isReinvest());
        System.out.println("Investment Loan Interest : " + nfmt.format(john.calculateInterestOnLoan()));
        ...
        System.out.println("Investment Loan Amount : " + nfmt.format(john2.getLoanamount()));
        System.out.println("Investment Loan Reinvest Option : " + john2.isReinvest());
        System.out.println("Investment Loan Interest : " + nfmt.format(john2.calculateInterestOnLoan()));
        ...
        System.out.println("Home Loan Amount : " + nfmt.format(doe.getLoanamount()));
        System.out.println("Home Loan Security : " + nfmt.format(doe.getSecurity()));
        System.out.println("Home Loan Interest : " + nfmt.format(doe.calculateInterestOnLoan()));
        ...
        System.out.println("Home Loan Amount : " + nfmt.format(doe2.getLoanamount()));
        System.out.println("Home Loan Security : " + nfmt.format(doe2.getSecurity()));
        System.out.println("Home Loan Interest : " + nfmt.format(doe2.calculateInterestOnLoan()));
        ...
        System.out.println("Home Loan Amount : " + nfmt.format(doe3.getLoanamount()));
        System.out.println("Home Loan Security : " + nfmt.format(doe3.getSecurity()));
        System.out.println("Home Loan Interest : " + nfmt.format(doe3.calculateInterestOnLoan()));
    }
